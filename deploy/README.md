...
application image (`ghcr.io/syntaktikeu/proxytrace`, also on Docker Hub as
...
-p 5102:8081 -v proxytrace:/data ghcr.io/syntaktikeu/proxytrace` — which is the quickest way
