...
namespace Proxytrace.Storage.Migrations
{
    ...
    [Migration("20260922170900_AddProjectDefaultUpstreamProvider")]
    partial class AddProjectDefaultUpstreamProvider
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Proxytrace.Storage.Internal.Entities.AgentCall.AgentCallEntity", b =>
                {
                    ...
                    b.Property<string>("ParentContinuationHash")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasIndex("ParentContinuationHash");
            ...
            modelBuilder.Entity("Proxytrace.Storage.Internal.Entities.Project.ProjectEntity", b =>
                {
                    ...
                    b.Property<Guid?>("DefaultUpstreamProviderId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DefaultUpstreamProviderId");
            ...
            modelBuilder.Entity("Proxytrace.Storage.Internal.Entities.Project.ProjectEntity", b =>
                {
                    b.HasOne("Proxytrace.Storage.Internal.Entities.ModelProvider.ModelProviderEntity", null)
                        .WithMany()
                        .HasForeignKey("DefaultUpstreamProviderId")
                        .OnDelete(DeleteBehavior.Restrict);
