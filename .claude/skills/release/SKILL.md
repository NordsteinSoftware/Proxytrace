...
docker manifest inspect ghcr.io/nordsteinsoftware/proxytrace:X.Y.Z   # image exists
docker manifest inspect ghcr.io/nordsteinsoftware/proxytrace:latest  # rolling tag moved (not for rc)
