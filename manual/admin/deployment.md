...
(`ghcr.io/nordsteinsoftware/proxytrace`, also on Docker Hub as `proxytrace/proxytrace`) either
directly or with the pinned compose file shipped on every
[GitHub release](https://github.com/NordsteinSoftware/Proxytrace/releases) — see
